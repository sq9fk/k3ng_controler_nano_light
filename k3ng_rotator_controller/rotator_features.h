...
#define FEATURE_AZ_ROTATION_STALL_DETECTION // Azimuth rotation stall detection - pin: az_rotation_stall_detected (D13, onboard LED) - catches a dead reed switch or a jammed rotor
